...
export const queryKeys = {
    ...
    outboundTestSettings: (id: number) => [...queryKeys.nodes, 'outbound-test-settings', id] as const,
    ...
    networkPortMapStatus: () => [...queryKeys.network, 'portmap', 'status'] as const,
    networkPortMapRules: () => [...queryKeys.network, 'portmap', 'rules'] as const,
