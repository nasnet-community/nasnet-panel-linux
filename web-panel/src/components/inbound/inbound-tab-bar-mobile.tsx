...
import type { TabId, TabDefinition } from "./use-inbound-form"
...
interface InboundTabBarMobileProps {
    tabs: TabDefinition[]
    activeTab: TabId
    onTabChange: (tab: TabId) => void
}

export function InboundTabBarMobile({ tabs, activeTab, onTabChange }: InboundTabBarMobileProps) {
    return (
